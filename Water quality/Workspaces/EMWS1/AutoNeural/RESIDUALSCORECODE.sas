...
END;
*** *****************************;
*** Writing the Residuals  of the Node Potability ;
*** ******************************;
IF MISSING( Potability1 ) THEN R_Potability1  = . ;
ELSE R_Potability1  = Potability1  - P_Potability1 ;
IF MISSING( Potability0 ) THEN R_Potability0  = . ;
ELSE R_Potability0  = Potability0  - P_Potability0 ;
*** *************************;
